...
{
    LOGD("Java_com_libre_mixtli_core_PixquiCore_nativeDestroyObject");
...
{
    LOGD("Java_com_libre_mixtli_core_PixquiCore_nativeDetect");
    ...
    LOGD("Java_com_libre_mixtli_core_PixquiCore_nativeDetect END");
}